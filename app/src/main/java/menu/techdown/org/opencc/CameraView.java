...
import static menu.techdown.org.opencc.MainActivity.sTess;
...
//grayscale
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ROI 선 조정
        mRelativeParams = new android.widget.RelativeLayout.LayoutParams(mRoiWidth + 50, mRoiHeight + 50);
        mRelativeParams.setMargins(mRoiX, mRoiY, 0, 0);
        mRelativeParams.addRule(RelativeLayout.CENTER_IN_PARENT, 1);
...
*/
      /*  //방향센서 핸들러 활성화
        ...
        if (!mOrientEventListener.canDetectOrientation()) {
            Toast.makeText(this, "방향센서 인식 오류 입니다.",
